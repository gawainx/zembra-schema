...
CREATE INDEX IF NOT EXISTS idx_notes_field_id ON notes(field_id);
...
CREATE INDEX IF NOT EXISTS idx_note_revisions_note_id_created_at ON note_revisions(note_id, created_at);
CREATE INDEX IF NOT EXISTS idx_note_revisions_device_id ON note_revisions(device_id);
